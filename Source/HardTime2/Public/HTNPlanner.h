...
public:
	...
	virtual EActions Operate(UPlayerData* playerData, USimWorld &world); //actual code that will be run to control the player when taking this action. Sets the player registers, and returns an action.
