...
public:
	...
	virtual bool LastActionSucceeded(HTNWorldState const& htnWorldState); //returns true if this operator appears to have succeeded. Is called after calling the 'Operate' function.
